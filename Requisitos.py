...
Objetivo: Crie um site para sua apresentação como pessoa desenvolvedora e
que sirva como seu currículo/portifólio. Nele você deve exibir os seguintes
itens:
...
Abriu e fechou corretamente as tags básicas de estrutura do HTML5, e não fez o uso
de atributos de aparência no HTML (CSS inline ou os atributos width/height)?
